...
// Fictional demo records only. These do not identify real players or payments.
export const SAMPLE_ADMIN_ORDERS: AdminOrder[] = [
  {
    id: 'WC3-1042',
    battleTag: 'DemoPlayerOne#1001',
    ...
    items: ['Plague Titan'],
    amountGold: 7,
    note: 'Fictional synced order for the demo interface.',
  },
  {
    id: 'WC3-1043',
    battleTag: 'DemoPlayerTwo#1002',
    ...
    amountGold: 5,
    note: 'Fictional payment status for the demo interface.',
  },
  {
    id: 'WC3-1044',
    battleTag: 'DemoPlayerThree#1003',
    ...
    items: ['Chrono King'],
    amountGold: 75,
    note: 'Fictional review order, no real purchase or customer.',
  },
]
